...
<a
	...
	class="group border-base-200 hover:text-secondary relative flex flex-col justify-start border-b p-(--cubiq-app-margin) pb-10 text-white transition-colors hover:bg-white md:border-r md:border-b-0 md:p-10 md:pb-10"
>
	<!-- Header -->
