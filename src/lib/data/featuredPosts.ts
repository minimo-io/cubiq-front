...
export const featuredPosts = {
	en: [
		...
		},
		{
			...
			image: '',
			excerpt:
				'Our Betizen project just got re-written and relaunched, aiming to create a fairness community for iGaming, Forex, and Binary listings, and we used our Users/Voting API to build it.',
	...
	es: [
		...
		},
		{
			...
			image: '',
			excerpt:
				'Nuestro proyecto Betizen acaba de ser reescrito y relanzado, con el objetivo de crear una comunidad de transparencia para listados de iGaming, Forex y Binarias, y utilizamos nuestra API de Usuarios/Votación para construirlo.',
			content: '<p>Soon.</p>\n',
			date: '3 de diciembre',
		...
		{
			title:
				'Transformers.js: Inferencia del lado del cliente para hacer nuestro e-commerce más inteligente',
			image: '',
			excerpt: 'En breve...',
			content: '<p>En breve...</p>\n',
	...
	pt: [
		...
		},
		{
			...
			image: '',
			excerpt:
				'Nosso projeto Betizen acabou de ser reescrito e relançado, com o objetivo de criar uma comunidade de transparência para listagens de iGaming, Forex e Binárias, e usamos nossa API de Usuários/Votação para construí-lo.',
		...
		{
			title:
				'Transformers.js: Inferência no lado do cliente para deixar nosso e-commerce mais inteligente',
			image: '',
			excerpt: 'En breve...',
			content: '<p>Em breve...</p>\n',
			date: '4 de setembro',
