	...
	en: [
		{
			...
			content: "<p>Cubiq was born with the intention of supporting growing companies, SMEs, and Startups that need a reliable and efficient technology partner to accompany their transformation.</p>\n<p>Cubiq is more than a development company or a collection of tools. We are a <span>Digital Products Platform</span> and a <a href=\"/en/lab\" class=\"text-primary\">Development Laboratory</a> that designs, builds, and deploys proprietary products as well as custom-made products for third parties.</p>\n<p>Our team provides the design and development that power the three service layers of our offering.</p>\n<p><strong class=\"text-primary\">//</strong> Here you can learn more about <a href=\"/en/#more\">our technology stack</a>.</p>\n<h2>The platform</h2>\n<p>Cubiq’s <a href=\"https://www.cubiq.lat/en\">integrated platform</a> is built on a base of 4 digital products:</p>\n<ul>\n<li><strong><a href=\"/en/care\">CARE</a></strong>: IT asset management and rental.</li>\n<li><strong><a href=\"/en/store\">STORE</a></strong>: Custom headless e-commerce.</li>\n<li><strong><a href=\"/en/pay\">PAY</a></strong>: BTC/USDT payments with instant settlement and cross-border support via Lightning.</li>\n<li><strong><a href=\"https://api.cubiq.lat/\">APIs</a></strong>: For startups that want to use the technologies that power our own products.</li>\n</ul>\n<p>But there are more products being incubated in the laboratory:</p>\n<ul>\n<li><strong>LAW</strong>: A micropayment tool that instantly analyzes global contracts, identifying risks and suggesting edits, eliminating the initial need for expensive lawyers.</li>\n</ul>\n<p>We are also a <a href=\"/en/lab\">DevLab</a>, offering custom development and a range of proprietary products.</p>\n<h2>The laboratory</h2>\n<p>Through its <a href=\"https://www.cubiq.lat\">Laboratory</a>, Cubiq experiments with and creates proprietary products such as:</p>\n<ul>\n<li><strong><a href=\"https://www.betizen.org/\">BETIZEN</a></strong>: The first Casino, Binary Options, and Forex listings site with the right incentives: karma, merit, and proof-of-work.</li>\n<li><strong><a href=\"/en/blog/beer-app\">TAPTAPGO</a></strong> (formerly Ln-Beer): TapTapGo connects breweries and bitcoiners with frictionless payments in satoshis.</li>\n</ul>\n<p><img src=\"/products/project-lightning-beer.webp\" alt=\"TapTapGo\"></p>\n<p>Additionally, the same programming and design team from the laboratory creates custom solutions for third parties.</p>\n<p>From brand development and design in Figma:</p>\n<p><img src=\"/clients/viivpay-splash.png\" alt=\"ViiVPay-Design\"></p>\n<p>To institutional websites:</p>\n<p><img src=\"/clients/agf-splash.jpeg\" alt=\"AGF-Splash\"></p>\n<p>From an e-commerce implementation:\n<img src=\"/clients/braaay-splash.jpeg\" alt=\"Braaay-Splash\"></p>\n<p>To mobile applications:</p>\n<p><img src=\"/clients/hops-splash.webp\" alt=\"Hops-Splash\"></p>\n<p><img src=\"/clients/loveinabox-splash.webp\" alt=\"LoveInABox-Splash\"></p>\n<p>We are the technology partner that enables companies and startups to focus on their core business.\n<br>\nIf you have an idea, get in touch and let’s schedule a conversation!</p>\n",
			date: "December 4",
	...
	pt: [
		{
			...
			content: "<p>A Cubiq nasceu com a intenção de apoiar empresas em crescimento, PMEs e Startups que precisam de um sócio tecnológico confiável e eficiente para acompanhar sua transformação.</p>\n<p>A Cubiq é mais do que uma empresa de desenvolvimento ou uma coleção de ferramentas. Somos uma <span>Plataforma de Produtos Digitais</span> e um <a href=\"/lab\" class=\"text-primary\">Laboratório de Desenvolvimento</a> que projeta, cria e implanta produtos próprios e produtos sob medida para terceiros.</p>\n<p>Nossa equipe fornece o design e o desenvolvimento que alimentam as três camadas de serviços da nossa oferta.</p>\n<p><strong class=\"text-primary\">//</strong> Aqui você pode conhecer mais sobre <a href=\"/#more\">nosso stack tecnológico</a>.</p>\n<h2>A plataforma</h2>\n<p>A <a href=\"https://www.cubiq.lat/\">plataforma integrada</a> da Cubiq conta com uma base de 4 produtos digitais:</p>\n<ul>\n<li><strong><a href=\"/care\">CARE</a></strong>: Gestão e locação de ativos de TI.</li>\n<li><strong><a href=\"/store\">STORE</a></strong>: E-commerce headless sob medida.</li>\n<li><strong><a href=\"/pay\">PAY</a></strong>: Pagamentos BTC/USDT com liquidação instantânea e cross-border, via Lightning.</li>\n<li><strong><a href=\"https://api.cubiq.lat/\">APIs</a></strong>: Para startups que desejam utilizar as tecnologias que impulsionam nossos próprios produtos.</li>\n</ul>\n<p>Mas há mais produtos sendo incubados no laboratório:</p>\n<ul>\n<li><strong>LAW</strong>: Uma ferramenta de micropagamentos que analisa instantaneamente contratos globais, identificando riscos e sugerindo edições, eliminando a necessidade inicial de advogados caros.</li>\n</ul>\n<p>Somos também um <a href=\"/lab\">DevLab</a>, oferecendo desenvolvimentos sob medida e uma série de produtos próprios.</p>\n<h2>O laboratório</h2>\n<p>Por meio de seu <a href=\"https://www.cubiq.lat\">Laboratório</a>, a Cubiq experimenta e cria produtos próprios como:</p>\n<ul>\n<li><strong><a href=\"https://www.betizen.org/\">BETIZEN</a></strong>: O primeiro site de listagens de Cassino, Binárias e Forex com os incentivos corretos: karma, mérito e proof-of-work.</li>\n<li><strong><a href=\"/blog/beer-app\">TAPTAPGO</a></strong> (antes Ln-Beer): A TapTapGo conecta cervejarias e bitcoiners com pagamentos em satoshis sem fricção.</li>\n</ul>\n<p><img src=\"/products/project-lightning-beer.webp\" alt=\"TapTapGo\"></p>\n<p>Além disso, a mesma equipe de programação e design do laboratório cria desenvolvimentos sob medida para terceiros.</p>\n<p>Desde desenvolvimento de marca e design no Figma:</p>\n<p><img src=\"/clients/viivpay-splash.png\" alt=\"ViiVPay-Design\"></p>\n<p>Até sites institucionais:</p>\n<p><img src=\"/clients/agf-splash.jpeg\" alt=\"AGF-Splash\"></p>\n<p>Desde uma implementação de e-commerce:\n<img src=\"/clients/braaay-splash.jpeg\" alt=\"Braaay-Splash\"></p>\n<p>Até aplicativos mobile:</p>\n<p><img src=\"/clients/hops-splash.webp\" alt=\"Hops-Splash\"></p>\n<p><img src=\"/clients/loveinabox-splash.webp\" alt=\"LoveInABox-Splash\"></p>\n<p>Somos o parceiro tecnológico que permite que empresas e startups foquem no seu negócio principal.\n<br>\nSe você tem uma ideia, entre em contato e agendamos uma conversa!</p>\n",
			date: "4 de dezembro",
